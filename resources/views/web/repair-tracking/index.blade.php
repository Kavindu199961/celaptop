...
<body>
    ...
    <div class="main-container">
        ...
        <div class="search-section">
            ...
            <p class="search-subtitle">Enter your customer number or repair item number to check repair status</p>

            <form class="search-form" method="GET">
                <div class="mb-2">
                    <input type="text" class="form-control search-input" 
                        name="tracking_number" placeholder="Enter Customer Number or Item Number (e.g., XX-0-0000 or PO-4-0001)" 
