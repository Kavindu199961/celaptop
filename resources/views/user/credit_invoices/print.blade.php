...
<head>
    <meta charset="UTF-8">
    <title>Invoice #{{ $creditInvoice->invoice_number }}</title>
    <style>
        @page {
...
<body>
    <div class="invoice-container">
        ...
        <table class="table-layout">
            <tr>
                <td>
                    <div class="details">
                        <p><strong>Invoice To:</strong> {{ $creditInvoice->creditShop->name }}</p>
                        <p><strong>Phone Number:</strong> {{ $creditInvoice->customer_phone }}</p>
                    </div>
                </td>
                <td>
                    <div class="section">
                        <p><strong>Invoice No:</strong> {{ $creditInvoice->invoice_number }}</p>
                        <p><strong>Issue Date:</strong> {{ \Carbon\Carbon::parse($creditInvoice->issue_date)->format('Y-m-d') }}</p>
                        <p><strong>Sales Rep:</strong> {{ $creditInvoice->sales_rep }}</p>
    ...
    <script>
        ...
        function closeReport() {
            window.location.href = "{{ route('user.credit_invoices.index') }}";
        }
    </script>
</body>
</html>
